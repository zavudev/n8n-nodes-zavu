...
export const broadcastFields: INodeProperties[] = [
	{
		displayName:
			'Sending a broadcast needs the account past the unverified level: identity verification, a saved payment method, a settled deposit, or a paid plan, any one of them. Business verification is not required. WhatsApp is exempt, because Meta\'s template approval is the review. It also passes through content review: a WhatsApp broadcast built on a Meta-approved template skips it; other channels wait for it. Drafts need nothing.',
